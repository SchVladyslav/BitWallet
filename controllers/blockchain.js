...
module.exports.transactions = async function (req, res) {
	let newTransaction = new Transaction(key.getPublic('hex'), req.body.toAddress, req.body.cryptoAmount, req.body.currency);
...
module.exports.recieve = async function (req, res) {
	let newTransaction = new Transaction(req.body.fromAddress, key.getPublic('hex'), req.body.cryptoAmount, req.body.currency);
	newTransaction.signTransaction(key);
	coin.addTransaction(newTransaction);
	try {
		res.status(statuses.createdStatus).json(newTransaction);
